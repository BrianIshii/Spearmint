...
class AddTransactionViewControllerOld: UIViewController, UITextFieldDelegate {
...
extension AddTransactionViewControllerOld : UITableViewDelegate {
...
extension AddTransactionViewControllerOld : UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        if section == 0 {
            return AddTransactionViewControllerOld.defaultFields
        } else {
